...
import app.project3.databinding.ActivitySetDataBinding
...
class SignUpActivity : AppCompatActivity() {
    ...
    lateinit var binding: ActivitySetDataBinding
    ...
    fun init() {
        ...
        binding.btSubmit.setOnClickListener {
            ...
            if (name.isEmpty()) {
                ...
                Toast.makeText(applicationContext, "sighup clicke", Toast.LENGTH_SHORT).show()
            }
        }
